"""
Q-learning temporal difference learning algorithm.
"""
...
class QLearner(AbstractStateActionValueFunctionTemporalDifferenceLearner):
    """
    Q-learning learner for discrete state and action spaces.
    """
    ...
    def learn(
        ...
        """
        Learn the optimal policy and value functions using Q-learning.
